...
def run(mode='rgb',
    ...
    top_10 = [[]]        #added to to code
    real_labels= []       #added to to code
    test_vedios = []        #added to to code
    test_labels=[[]]          #added to to code
    ...
    for c, data in enumerate(dataloaders["test"], 1):
        ...
        real_labels.append(lbl)   #added to to code
        top_10.append(out_labels[-10:][::-1])   #added to to code
        test_vedios.append(video_id)        #added to to code
        test_labels.append(labels)        #added to to code
        ...
        # print(str(c) + ' / ' + str(len(dataloaders['test'])), video_id[0], float(correct) / len(dataloaders["test"]), float(correct_5) / len(dataloaders["test"]),
        #       float(correct_10) / len(dataloaders["test"]),lbl,out_labels[-10:][::-1])    ###Addeded to code 
